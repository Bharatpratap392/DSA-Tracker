...
int main()
{
    ...
    while (n > 0) // This loop runs until all digits are processed.
    {
        ...
        n /= 10;                             // Removes the last digit from n. If n = 153, after this line, n = 15.
        sum = sum + (digit * digit * digit); // Adds the cube of the digit to the sum. So, for digit 3: sum += 3³ = 27.
    }
